...
namespace Wagebat.Data.Migrations
{
    ...
    [Migration("20220620083839_AddIsImageColumnToCommentAttachments")]
    partial class AddIsImageColumnToCommentAttachments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wagebat.Models.CommentAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wagebat.Models.CommentAttachment", b =>
                {
                    b.HasOne("Wagebat.Models.Comment", "Comment")
            ...
            modelBuilder.Entity("Wagebat.Models.Review", b =>
                {
                    b.HasOne("Wagebat.Models.Transaction", "Transaction")
                        .WithOne("Review")
                        .HasForeignKey("Wagebat.Models.Review", "TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
